(() => {
    ...
    (i.m = s),
        ...
        (i.e = (t) =>
            Promise.all(
                Object.keys(i.f).reduce((e, s) => (i.f[s](t, e), e), [])
            )),
        (i.u = (t) => {
        ...
        renderPager() {
            if ((l(this.pagers), this.totalPages > 1)) {
                ...
                this.options.truncatePager &&
                    (i = ((t, e, s, a, i) => {
                        ...
                        return (
                            d.forEach((e) => {
                                ...
                                if (n) {
                                    const e =
                                        n.children[0].getAttribute("data-page");
                                    if (s - e == 2) c.push(t[e]);
                                    else if (s - e != 1) {
                                        const t = r("li", {
                                            class: "ellipsis",
                    ...
                    this.options.firstLast &&
                        e.appendChild(
                            h(t, this.totalPages, this.options.lastText)
                        ),
    ...
    function y() {
        ...
        var a,
            i = f(
                m.wrapper.querySelectorAll("ul.dataTable-pagination-list li")
            );
        try {
            for (i.s(); !(a = i.n()).done; ) {
        ...
        var n,
            r = f(
                m.wrapper.querySelectorAll("ul.dataTable-pagination-list li a")
            );
        try {
            for (r.s(); !(n = r.n()).done; ) {
